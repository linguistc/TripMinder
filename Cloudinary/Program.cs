...
class Program
{
    static void Main(string[] args)
    {
        ...
        //     
        //     string folder = @"E:\college\g-data\Cairo Image\Cairo Image\cairo Accommodation";
        //
        //     foreach (var a in accomodations)
        //     {
        //         string localPath = Path.Combine(folder, $"{a.Id}.png");
        //
        //         if (!File.Exists(localPath))
        //         {
        ...
        //
        //     string folder = @"E:\college\g-data\Cairo Image\Cairo Image\cairo restaurants";
        //
        //     foreach (var r in restaurants)
        //     {
        //         string localPath = Path.Combine(folder, $"{r.Id}.png");
        //
        //         if (!File.Exists(localPath))
        //         {
        ...
        //
        //     string folder = @"E:\college\g-data\Cairo Image\Cairo Image\cairo entertainment";
        //
        ...
        //
        //     string folder = @"E:\college\g-data\Cairo Image\Cairo Image\cairo tourism";
        //     
        //     foreach (var t in tourismAreas)
        //     {
        //         string localPath = Path.Combine(folder, $"{t.Id}.png");
        //
        //         if (!File.Exists(localPath))
        //         {
